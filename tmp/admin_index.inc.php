...
switch ($route) {
	...
	case 'notice': include _include(APP_PATH.'plugin/huux_notice/route/notice.php'); break;case 'credits_paylog': include APP_PATH.'plugin/tt_credits/admin_creditslog.php'; break;
