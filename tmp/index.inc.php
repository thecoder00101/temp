...
case 'discovery': 	include _include(APP_PATH.'plugin/zaesky_theme_light/route/discovery.php'); 	break;
case 'index': 	include _include(APP_PATH.'plugin/zaesky_theme_light/route/index.php'); 	break;
...
case 'prison': include _include(APP_PATH.'plugin/fox_prison/oddfox/route/prison.php'); break;
case 'hei': include APP_PATH.'/plugin/fox_prison/hook/hei.htm'; break;
...
case 'vcode': include _include(APP_PATH.'plugin/shee_vcode/route/vcode.php'); break;case 'pass': include _include(APP_PATH.'plugin/till_thread_passcode/route/pass.php'); break;



case 'ranklist': 	include _include(APP_PATH.'plugin/tt_ranklist/route/ranklist.php'); 	break;
		case 'search': include _include(APP_PATH.'plugin/xn_search/route/search.php'); break;case 'upload_img': include _include(APP_PATH.'plugin/xn_tinymce/upload/upload.php'); break;
		default: 
