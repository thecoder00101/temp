...
<?php foreach($data as $v){?><tr>
    <td><a href="/<?php echo url("thread-{$v['tid']}");?>"><?php echo subject($v['tid'])?></a></td><td><a href="/<?php echo url("user-$v[uid]");?>" ><?php echo username($v['uid']); ?></a></td><td><?php echo $v['num'],lang('credits'.$v['credit_type']);?></td><td><?php echo date('Y-m-d',$v['paytime']); ?></td>
</tr><?php }?></table>
