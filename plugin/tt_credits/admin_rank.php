...
<?php foreach($data as $v){?><tr><td><a href="/<?php echo url("user-$v[uid]")?>" ><?php echo$v['username'];?></a></td><td><?php echo $v['credits'];?></td><td><?php echo $v['golds'];?></td><td><?php echo $v['rmbs'];?></td></tr><?php }?></table>
